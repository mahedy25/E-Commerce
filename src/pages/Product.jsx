    ...
    <div className='border-t-2 pt-10 transition-opacity ease-in duration-500 opacity-100'>
      ...
      <div className='flex gap-12 sm:gap-12 flex-col sm:flex-row'>
        ...
        <div className='flex-1'>
          ...
          <button onClick={()=>addToCart(productData._id,size)} className='bg-black text-white px-8 py-3 text-sm active:bg-cyan-500 '>Add To Cart</button>
      ...
      <div className='mt-20'>
        <div className='flex'>
          ...
          <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Eos numquam ipsam odit dolore veritatis laudantium placeat vitae nihil veniam delectus!</p>
          <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptate, est? Lorem ipsum dolor sit amet.</p>
         </div>
      </div>
