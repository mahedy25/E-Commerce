      ...
      <div>
        {
          cartData.map((item,index)=>{
            ...
            return (
              <div key={index} className='py4 border-t border-b text-gray-700 grid grid-cols-[4fr_0.5fr_0.5fr] sm:grid-cols-[4fr_2fr_0.5fr] items-center gap-4 '>
      ...
      <div className='flex justify-end my-20'>
        ...
        <div className='w-full sm:w-[450px]'>
           ...
           <div className='w-full text-end'>
            <button onClick={()=>navigate('/place-order')} className='bg-black text-white text-sm my-8 p-3 active:bg-cyan-500'>Proceed To Checkout</button>
           </div>
        </div>
      </div>
    </div>
